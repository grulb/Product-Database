...
namespace My_Database {
    ...
    public partial class ShopDBDataSet3 : global::System.Data.DataSet {
        ...
        public partial class productstableDataTable : global::System.Data.TypedTableBase<productstableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productstableRow AddproductstableRow(int productid, string productname, string productsum, string productcount) {
...
namespace My_Database.ShopDBDataSet3TableAdapters {
    ...
    public partial class productstableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"ShopDB\".\"public\".\"productstable\" (\"productid\", \"productname\", \"produ" +
                "ctsum\", \"productcount\") VALUES (@productid, @productname, @productsum, @productc" +
                "ount)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""ShopDB"".""public"".""productstable"" SET ""productid"" = @productid, ""productname"" = @productname, ""productsum"" = @productsum, ""productcount"" = @productcount WHERE ((""productid"" = @Original_productid) AND ((@IsNull_productname = 1 AND ""productname"" IS NULL) OR (""productname"" = @Original_productname)) AND ((@IsNull_productsum = 1 AND ""productsum"" IS NULL) OR (""productsum"" = @Original_productsum)) AND ((@IsNull_productcount = 1 AND ""productcount"" IS NULL) OR (""productcount"" = @Original_productcount)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \"productid\", \"productname\", \"productsum\", \"productcount\" FROM \"public\".\"pr" +
                "oductstable\"";
        ...
        public virtual int Fill(ShopDBDataSet3.productstableDataTable dataTable) {
        ...
        public virtual ShopDBDataSet3.productstableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShopDBDataSet3.productstableDataTable dataTable = new ShopDBDataSet3.productstableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShopDBDataSet3.productstableDataTable dataTable) {
        ...
        public virtual int Insert(int @productid, string @productname, string @productsum, string @productcount) {
        ...
        public virtual int Update(int @productid, string @productname, string @productsum, string @productcount, int @Original_productid, string @Original_productname, string @Original_productsum, string @Original_productcount) {
            ...
            if ((@Original_productsum == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(@Original_productsum));
            }
            if ((@Original_productcount == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(@Original_productcount));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string @productname, string @productsum, string @productcount, int @Original_productid, string @Original_productname, string @Original_productsum, string @Original_productcount) {
            return this.Update(@Original_productid, @productname, @productsum, @productcount, @Original_productid, @Original_productname, @Original_productsum, @Original_productcount);
        }
    }
